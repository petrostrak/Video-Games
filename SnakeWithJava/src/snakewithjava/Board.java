...
public class Board extends JPanel implements ActionListener{
    ...
    /*
        ...
        of the board. The DOT_SIZE is the size of the apple 
        and the dot of the snake. The ALL_DOTS constant defines 
        the maximum number of possible dots on the board (900 = (300*300)/(10*10)). 
        The RAND_POS constant is used to calculate a random position 
        for an apple. The DELAY constant determines the speed of the game
    */
    ...
    // In the loadImages() method we get the images for the game. The ImageIcon class 
    // is used for displaying PNG images.
